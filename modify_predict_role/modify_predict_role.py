...
class SampleAgent(object):
    def __init__(self, agent_name):
        ...
        self.w_data = modify_predict_role_data_info(agent_num=10,train_mode=False,train_times=10000,net_load=False,test_train_mode=False,each_model=False,kanning=False)
