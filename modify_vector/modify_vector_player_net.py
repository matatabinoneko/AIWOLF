...
from aiwolf_func_modify_vector import *
...
class SampleAgent(object):
    def __init__(self, agent_name):
        ...
        self.w_data = modify_vector_data_info(agent_num=5,daily_train=False,player_train=False,train_times=10000,each_model=False)
