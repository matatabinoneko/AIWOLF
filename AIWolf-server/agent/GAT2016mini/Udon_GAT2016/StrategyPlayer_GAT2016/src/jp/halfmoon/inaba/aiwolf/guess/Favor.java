...
import jp.halfmoon.inaba.aiwolf.lib.AgentParameterItem;
	...
	public ArrayList<Guess> getGuessList(GuessStrategyArgs args) {
		...
		for( Agent agent : gameInfo.getAgentList() ){
			...
			if( role == Role.WEREWOLF){
				...
				guess.correlation = 1.0 - args.agentParam.getParam(AgentParameterItem.FAVOR_RATE, 1.0) * ((double)aliveWolfNum / restExecuteNum);
				guesses.add(guess);
