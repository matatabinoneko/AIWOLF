	 ...
	 public static void main(String[] args) {
		 ...
		 */
		 ...
		 try{
			 ...
			 //PersonalityFactory.setPersonality(team,aaa.get(0), aaa.get(1), aaa.get(2), aaa.get(3), aaa.get(4));
			 PersonalityFactory.setPersonalityRange(Team.VILLAGER, null, null, null, null, new Pair<Double,Double>(0.9,1.0));
			 PersonalityFactory.setPersonalityRange(Team.WEREWOLF, null, null, null, null, new Pair<Double,Double>(0.9,1.0));
			 
			 if(aaa.get(4)!=null){
				 PersonalityFactory.setPersonalityRange(team,aaa.get(0), aaa.get(1), aaa.get(2), aaa.get(3),aaa.get(4));
			 }
			 else{
				 PersonalityFactory.setPersonalityRange(team,aaa.get(0), aaa.get(1), aaa.get(2), aaa.get(3), new Pair<Double,Double>(0.9,1.0));
			 }
			 ...
			 /*
			 int win=game.getWinner()==Team.VILLAGER?1:0;
			 for(Player temp : playerList){
				 WasabiPlayer wp=(WasabiPlayer)temp;
				 Personality p=wp.getPersonality();
				 Role role=wp.getRole();
				 pw.println(role+","+p.openness_to_experimence+","+p.conscientiousness+","+p.extroversion+","+p.agreeableness+","+p.neuroticism+","+win);
			 }*/
