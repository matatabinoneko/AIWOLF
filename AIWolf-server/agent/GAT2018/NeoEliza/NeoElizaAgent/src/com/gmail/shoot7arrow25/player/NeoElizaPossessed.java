 ...
 * 裏切り者役エージェントクラス
 */
public class NeoElizaPossessed extends NeoElizaBasePlayer {
        ...
        private Judge getFakeDivination() {
            ...
            // 偽人狼に余裕があれば，人狼と人間の割合を勘案して，10%の確率で人狼と判定
            // 公式サンプルでは20%だった値を10％に変更した。
            ...
            if (nFakeWolves < numWolves && Math.random() < 0.1) {
