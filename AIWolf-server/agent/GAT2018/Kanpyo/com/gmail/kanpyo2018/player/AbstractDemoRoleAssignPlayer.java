...
/**
 * プレイヤのAbstractクラス プレイヤはこれを継承して実装する
 *
 * @author k14096kk
 *
 */
public abstract class AbstractDemoRoleAssignPlayer implements Player {
	...
	public AbstractDemoRoleAssignPlayer() {
	}
