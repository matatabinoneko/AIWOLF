 ...
 * 占い師役エージェントクラス
 */
public class KurageSeer extends KurageVillager {
    int comingoutDay;
    boolean isCameout;
    ...
    protected void chooseVoteCandidate() {
        ...
        for (Judge j : identList) {
            ...
            if ((myDivinationMap.containsKey(j.getTarget()) &&
                    j.getResult() != myDivinationMap.get(j.getTarget()))) {
